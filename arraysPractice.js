...
var evenNumbers = function(nums, evens, odds) {
    for (var i = 0; i < nums.length; i++) {
...
var addItem = [];
  ...
  var removeItem = function(){
      for (var i = 0; i < myGroceryList; i++) {
          return myGroceryList[i].unshift().push(addItem);
      };
  };
...
var newList = myGroceryList[i].unshift();

var newest = myGroceryList[i].pop('Jerky');
...
var addTen = function(){
  ...
  for(var i = 0; i < newi.length; i++) {
    newi.push(parseInt(numbers[i])) + 10);
  }
  return newi;
}
